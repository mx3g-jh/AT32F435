...
/* Basic operations */
#define ST7789_RST_Clr() _GPIO_LCD_RES_L()
#define ST7789_RST_Set() _GPIO_LCD_RES_H()

#define ST7789_DC_Clr() _GPIO_LCD_DC_L()
#define ST7789_DC_Set() _GPIO_LCD_DC_H()

#define ST7789_BLK_Clr() _GPIO_LCD_BLK_L()
#define ST7789_BLK_Set() _GPIO_LCD_BLK_H()

#ifndef CFG_NO_CS
#define ST7789_Select() _GPIO_LCD_CS_L()
#define ST7789_UnSelect() _GPIO_LCD_CS_H()
#else
