...
LV_IMG_DECLARE(_btn4_alpha_115x164);
LV_IMG_DECLARE(_btn_bg_1_alpha_85x117);
LV_IMG_DECLARE(_btn3_alpha_85x117);
LV_IMG_DECLARE(_scan_29x34);
LV_IMG_DECLARE(_btn4_alpha_85x117);
LV_IMG_DECLARE(_tel_21x24);
LV_IMG_DECLARE(_pc_21x24);
LV_IMG_DECLARE(_btn2_alpha_115x164);
LV_IMG_DECLARE(_internet_30x35);
LV_IMG_DECLARE(_btn2_alpha_85x117);
LV_IMG_DECLARE(_hue_21x24);
LV_IMG_DECLARE(_printer2_60x64);
LV_IMG_DECLARE(_no_internet_25x29);
LV_IMG_DECLARE(_example_250x161);
LV_IMG_DECLARE(_phone_45x64);
LV_IMG_DECLARE(_btn3_alpha_115x164);
LV_IMG_DECLARE(_ready_100x117);
LV_IMG_DECLARE(_print_29x34);
LV_IMG_DECLARE(_mobile_30x35);
LV_IMG_DECLARE(_cloud_55x47);
LV_IMG_DECLARE(_setup_29x34);
LV_IMG_DECLARE(_eco_21x24);
LV_IMG_DECLARE(_wave_25x29);
LV_IMG_DECLARE(_wifi_29x22);
LV_IMG_DECLARE(_bright_24x28);
LV_IMG_DECLARE(_example_300x202);
LV_IMG_DECLARE(_usb_30x35);
LV_IMG_DECLARE(_copy_29x34);
